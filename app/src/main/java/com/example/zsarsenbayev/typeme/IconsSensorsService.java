...
public class IconsSensorsService extends Service implements SensorEventListener {
    ...
    public void onCreate() {
        ...
        File dataDirectory = new File(this.getExternalFilesDir(null), DisplayGridActivity.WORKING_DIRECTORY);
